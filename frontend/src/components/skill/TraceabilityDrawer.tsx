...
export function TraceabilityDrawer({ grainIds, avgSimilarity, open, onClose, orgSkillId }: TraceabilityDrawerProps) {
  ...
  return (
    <>
      ...
      {/* 抽屉 */}
      <div className="fixed top-0 right-0 bottom-0 w-[420px] max-w-[92vw] bg-white z-[101] shadow-[-8px_0_30px_rgba(0,0,0,0.12)] flex flex-col overflow-hidden animate-[slideInRight_0.3s_ease-out]">
